...
class Talk(object):
    ...
    @loggedIn
    def sendMessageWithMentionAndFooter(self, to, text, mid, agent_name):
        msg = Message()
        ...
        msg.contentMetadata = {
            ...
            'AGENT_ICON':'https://goo.gl/rxF7oy',
            'AGENT_NAME':str(agent_name),
            'AGENT_LINK':'https://line.me/ti/p/~bamaseptituta.'
        }
        return self.talk.sendMessage(0,msg)

    @loggedIn
    def sendImageWithFooter(self, to, path):
        params = {
            'AGENT_ICON': 'https://goo.gl/rxF7oy',
            'AGENT_NAME': 'Bama Septituta',
            'AGENT_LINK': 'https://www.instagram.com/bama.septituta'
       }
